...
<div class="flex flex-col items-center justify-center px-6 mx-auto lg:py-0 my-10 w-full mt-[150px]">
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="index.php?action=signAction" method="post" id="signin-form">
                ...
                <div>
                  ...
                  <button type="submit" id="signin" class="w-full uppercase tracking-wide text-white bg-black hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login</button>
